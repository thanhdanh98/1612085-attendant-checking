...
import {
	AppService, AuthService, SocketService, CreateAbsenceRequestModalComponent, SendFeedbackModalComponent,
...
export class DashboardStudentComponent implements OnInit {
	...
	@ViewChild(CreateAbsenceRequestModalComponent, { static: false })
	...
	@ViewChild(SendFeedbackModalComponent, { static: false })
