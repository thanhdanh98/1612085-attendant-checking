...
import {
    CourseService, StudentService, AttendanceService, AppService, MapService, EditScheduleModalComponent,
    ScheduleService, ResultMessageModalComponent, AuthService, ExcelService, ImportModalComponent, MapModalComponent
...
export class CourseDetailStaffComponent implements OnInit {
    ...
    @ViewChild(ResultMessageModalComponent, { static: false })
    ...
    //Schedule
    @ViewChild(EditScheduleModalComponent, { static: false })
    ...
    public import_title;
    @ViewChild(ImportModalComponent, { static: false })
    ...
    public map_title;
    @ViewChild(MapModalComponent, { static: false })
