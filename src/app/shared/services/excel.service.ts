...
export class ExcelService {
    ...
    public s2ab(s: { length: number; charCodeAt: (arg0: number) => number; }): any {
    ...
    public readStudentListFile(file: any): Observable<{ result: string, message: string, student_list: Array<any> }> {
        return new Observable<any>((observer) => {
            XlsxPopulate.fromDataAsync(file)
                .then((workbook: { sheet: (arg0: number) => void; }) => {
        ...
        }).catch((error: any) => Observable.of({ result: 'failure', message: error, student_list: null }));
    }
    ...
    public readTeacherListFile(file: any): Observable<{ result: string, teacher_list: Array<any>, message: string }> {
        ...
        }).catch((error: any) => Observable.of({ result: 'failure', message: error, teacher_list: null }));
    }
    ...
    public readCourseListFile(file: any): Observable<{ result: string, course_list: Array<any>, message: string }> {
        ...
        }).catch((error: any) => Observable.of({ result: 'failure', message: error, course_list: null }));
    }
    ...
    public readScheduleFile(file: any): Observable<{ result: string, schedule: any, message: string }> {
        ...
        }).catch((error: any) => Observable.of({ result: 'failure', schedule: null, message: error }));
    }
    ...
    public readAttendanceListFile(file: any): Observable<{ result: string, attendance_list: Array<any>, message: string }> {
        ...
        }).catch((error: any) => Observable.of({ result: 'failure', attendance_list: null, message: error }));
    }
